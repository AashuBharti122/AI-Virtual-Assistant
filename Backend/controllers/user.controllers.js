...
export const getCurrentUser = async (req, res) => {
  try {
    ...
    return res.status(400).json({ message: "Server Error fetching user" });
  }
};
...
export const updateAssistant = async (req, res) => {
  try {
    ...
    return res.status(400).json({ message: "Server Error updating assistant" });
  }
};
    ...
    switch (type) {
      ...
      default:
        return res.status(400).json({
          response: "I don't understand this command yet.",
        });
